...
namespace MoreMountains.Tools
{
	...
	/// <summary>
	/// 这个类可以让你收集、回收和生成浮动文本，通常用来显示伤害信息。它需要一个MMFloatingText对象作为输入。
	...
	public class MMFloatingTextSpawner : MMMonoBehaviour
	{
		...
		/// <summary>
		/// 生成的文本是否应具有固定对齐方式、方向是否匹配初始生成方向或其移动曲线
