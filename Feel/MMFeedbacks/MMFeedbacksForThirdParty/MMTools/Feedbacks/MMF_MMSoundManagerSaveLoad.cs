...
{
	/// <summary>
	/// 此反馈将允许您触发MMSoundManager设置的保存、加载和重置。您需要在场景中安装一个MMSoundManager才能正常工作。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("Audio（音效）/MMSoundManager Save and Load（声音保存、加载、重置）")]
	[FeedbackHelp("此反馈将允许您触发MMSoundManager设置的保存、加载和重置。您需要在场景中安装一个MMSoundManager才能正常工作。")]
