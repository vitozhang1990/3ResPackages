...
{
	/// <summary>
	/// 通过此反馈，您可以随时间控制RectTransform的大小增量属性（相对于定位点之间的距离的此RectTransorm的大小）
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("通过此反馈，您可以随时间控制RectTransform的大小增量属性（相对于定位点之间的距离的此RectTransorm的大小）")]
	[FeedbackPath("UI/RectTransform SizeDelta（控制RectTransform的大小增量）")]
