...
{
	/// <summary>
	/// 此反馈将触发后处理移动筛选器事件，该事件将由MMPostProcessingMovableFilter对象捕获
    ...
    /// </summary>
    [AddComponentMenu("")]
	[FeedbackHelp("此反馈将触发后处理移动筛选器事件，该事件将由MMPostProcessingMovableFilter对象捕获")]
	[FeedbackPath("PostProcess（后处理）/PPMovingFilter（处理移动筛选器事件）")]
