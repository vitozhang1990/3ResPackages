...
{
	/// <summary>
	/// 此反馈将使您（几乎）瞄准场景中任何对象上的任何属性。它也适用于可编写脚本的对象。拖动一个对象，选择一个属性，然后设置反馈以随时间更新该属性
    ...
    /// </summary>
    [AddComponentMenu("")]
	[FeedbackHelp("此反馈将使您（几乎）瞄准场景中任何对象上的任何属性。它也适用于可编写脚本的对象。拖动一个对象，选择一个属性，然后设置反馈以随时间更新该属性")]
	[FeedbackPath("GameObject（游戏对象）/Property（属性设置）")]
