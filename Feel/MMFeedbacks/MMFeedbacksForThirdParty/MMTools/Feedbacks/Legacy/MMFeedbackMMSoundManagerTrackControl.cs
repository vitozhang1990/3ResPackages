...
{
	/// <summary>
	/// 此反馈将允许您控制在特定曲目（主曲目、UI、音乐、sfx）上播放的所有声音，并同时播放、暂停、静音、取消静音、恢复、停止和释放所有声音。您需要在场景中安装一个MMSoundManager才能正常工作。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("Audio（音效）/MMSoundManager Track Control（控制指定音轨上控制所有声音）")]
	[FeedbackHelp("此反馈将允许您控制在特定曲目（主曲目、UI、音乐、sfx）上播放的所有声音，并同时播放、暂停、静音、取消静音、恢复、停止和释放所有声音。您需要在场景中安装一个MMSoundManager才能正常工作。")]
