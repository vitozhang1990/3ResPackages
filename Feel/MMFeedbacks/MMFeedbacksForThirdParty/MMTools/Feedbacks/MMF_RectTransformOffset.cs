...
{
	/// <summary>
	/// 通过此反馈，可以控制矩形左下角相对于左下定位点的偏移，以及矩形右上角相对于右上定位点的偏差。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("通过此反馈，可以控制矩形左下角相对于左下定位点的偏移，以及矩形右上角相对于右上定位点的偏差。")]
	[FeedbackPath("UI/RectTransform Offset（控制矩形左下角相对于左下定位点的偏移）")]
