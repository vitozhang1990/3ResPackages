...
{
	/// <summary>
	/// 此反馈允许您随时间控制色差强度。它要求您在场景中有一个对象，该对象具有激活色差的后处理体积，以及一个MMC色差抖动组件。
	...
	[FeedbackPath("PostProcess（后处理）/Chromatic Aberration（控制色差强度）")]
	#endif
	[FeedbackHelp("此反馈允许您随时间控制色差强度。它要求您在场景中有一个对象，该对象具有激活色差的后处理体积，以及一个MMC色差抖动组件。")]
