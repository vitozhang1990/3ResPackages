...
{
	/// <summary>
	/// 此反馈允许您随时间控制景深焦距、光圈和焦距。它要求场景中有一个具有激活景深的后处理体积的对象，以及一个MMDepthOfFieldShaker组件。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("此反馈允许您随时间控制景深焦距、光圈和焦距。它要求场景中有一个具有激活景深的后处理体积的对象，以及一个MMDepthOfFieldShaker组件。")]
	#if MM_POSTPROCESSING
	[FeedbackPath("PostProcess（后处理）/Depth Of Field（控制景深焦距、光圈和焦距）")]
	#endif
