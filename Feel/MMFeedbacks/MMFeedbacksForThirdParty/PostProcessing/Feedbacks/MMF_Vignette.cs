...
{
	/// <summary>
	/// 此反馈允许您随时间控制渐晕强度。它要求场景中有一个对象，该对象具有激活了渐晕的后处理体积和MMVignetteShaker组件。
	...
	[FeedbackPath("PostProcess（后处理）/Vignette（渐晕强度）")]
	#endif
	[FeedbackHelp("此反馈允许您随时间控制渐晕强度。它要求场景中有一个对象，该对象具有激活了渐晕的后处理体积和MMVignetteShaker组件。")]
