...
{
	/// <summary>
	/// 此反馈允许您随时间控制曝光后的颜色分级、色调偏移、饱和度和对比度。它要求在场景中有一个对象，该对象具有激活颜色分级的后处理体积和MMColorGradingShaker组件。
	...
	[FeedbackPath("PostProcess（后处理）/Color Grading（曝光后颜色调整）")]
	#endif
	[FeedbackHelp("此反馈允许您随时间控制曝光后的颜色分级、色调偏移、饱和度和对比度。它要求在场景中有一个对象，该对象具有激活颜色分级的后处理体积和MMColorGradingShaker组件。")]
