...
{
    /// <summary>
    /// 此反馈允许您随时间控制镜头畸变强度。它要求在场景中有一个对象，该对象具有激活镜头扭曲的后处理体积，以及一个MMLensDistorationShaker组件。
    ...
    /// </summary>
    [AddComponentMenu("")]
    [FeedbackPath("PostProcess（后处理）/Lens Distortion（控制镜头畸变强度）")]
    [FeedbackHelp("此反馈允许您随时间控制镜头畸变强度。它要求在场景中有一个对象，该对象具有激活镜头扭曲的后处理体积，以及一个MMLensDistorationShaker组件。")]
