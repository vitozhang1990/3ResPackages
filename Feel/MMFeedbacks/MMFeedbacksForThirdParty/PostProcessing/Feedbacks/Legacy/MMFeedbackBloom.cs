...
{
	/// <summary>
	/// 此反馈允许您随时间控制开花强度和阈值。它要求场景中有一个对象，该对象具有Bloom处于活动状态的后处理体积和MMBloomShaker组件。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("此反馈允许您随时间控制开花强度和阈值。它要求场景中有一个对象，该对象具有Bloom处于活动状态的后处理体积和MMBloomShaker组件。")]
	[FeedbackPath("PostProcess（后处理）/Bloom（控制开花强度和阈值）")]
