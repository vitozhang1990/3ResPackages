...
{
	/// <summary>
	/// 使用此反馈播放重点触觉，即短触觉突发，其幅度和频率可以实时控制，在CoreActics/iOS中也称为瞬态
	...
	[AddComponentMenu("")]
	#if MOREMOUNTAINS_NICEVIBRATIONS_INSTALLED
	[FeedbackPath("Haptics（触觉反馈）/Haptic Emphasis（重点触觉，短触觉突发，瞬态）")]
	#endif 
	[FeedbackHelp("使用此反馈播放重点触觉，即短触觉突发，其幅度和频率可以实时控制，在CoreActics/iOS中也称为瞬态")]
