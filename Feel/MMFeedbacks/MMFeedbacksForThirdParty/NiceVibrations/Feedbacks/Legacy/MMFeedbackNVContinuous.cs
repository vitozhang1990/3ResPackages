...
{
	/// <summary>
	/// 添加此反馈以在特定持续时间内播放指定振幅和频率的连续触觉。这种反馈还可以让你随机化这些，并随时间调整它们。
	...
	[AddComponentMenu("")]
	#if MOREMOUNTAINS_NICEVIBRATIONS_INSTALLED
	[FeedbackPath("Haptics（触觉反馈）/Haptic Continuous（放指定振幅和频率的连续触觉）")]
	#endif
	[FeedbackHelp("添加此反馈以在特定持续时间内播放指定振幅和频率的连续触觉。这种反馈还可以让你随机化这些，并随时间调整它们。")]
