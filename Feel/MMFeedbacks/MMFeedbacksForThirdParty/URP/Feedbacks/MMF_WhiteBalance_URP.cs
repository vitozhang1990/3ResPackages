...
{
	/// <summary>
	/// 此反馈允许您随时间控制白平衡温度和色调。它要求场景中有一个具有激活白平衡的体积的对象，以及MMWhiteBalanceShaker_URP组件。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("此反馈允许您随时间控制白平衡温度和色调。它要求场景中有一个具有激活白平衡的体积的对象，以及MMWhiteBalanceShaker_URP组件。")]
#if MM_URP
	[FeedbackPath("PostProcess（后处理）/White Balance URP（URP控制白平衡温度和色调）")]
#endif
