...
{
	/// <summary>
	/// 此反馈允许您控制随时间变化的URP透镜畸变强度。它要求在场景中有一个具有激活镜头扭曲的体积的对象，以及一个MMLensDistortionShaker_URP组件。
	...
	[AddComponentMenu("")]
#if MM_URP
	[FeedbackPath("PostProcess（后处理）/Lens Distortion URP（URP透镜畸变强度）")]
#endif
	[FeedbackHelp("此反馈允许您控制随时间变化的URP透镜畸变强度。它要求在场景中有一个具有激活镜头扭曲的体积的对象，以及一个MMLensDistortionShaker_URP组件。")]
