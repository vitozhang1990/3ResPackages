...
{
	/// <summary>
	/// 此反馈允许您随时间控制色差强度。它要求在场景中有一个体积为URP色差活动的对象，以及一个MMChromaticAberrationShaker_URP组件。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("此反馈允许您随时间控制色差强度。它要求在场景中有一个体积为URP色差活动的对象，以及一个MMChromaticAberrationShaker_URP组件。")]
#if MM_URP
	[FeedbackPath("PostProcess（后处理）/Chromatic Aberration URP（URP控制色差强度）")]
#endif
