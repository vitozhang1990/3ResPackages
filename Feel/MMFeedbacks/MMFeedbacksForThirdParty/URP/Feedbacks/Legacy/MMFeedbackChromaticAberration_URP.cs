...
{
	/// <summary>
	/// 此反馈允许您随时间控制色差强度。它要求在场景中有一个体积为URP色差活动的对象，以及一个MMCOLORICALABERROTIONSHAKER_URP组件。
	...
	[FeedbackHelp("此反馈允许您随时间控制色差强度。它要求在场景中有一个体积为URP色差活动的对象，以及一个MMCOLORICALABERROTIONSHAKER_URP组件。")]
