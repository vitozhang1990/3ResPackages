...
{
	/// <summary>
	/// 此反馈允许您随时间控制URP膜颗粒强度。它要求场景中有一个体积为“Film Grain”活动的对象，以及一个MMFilmGrainShaker_URP组件。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("PostProcess（后处理）/Film Grain URP（URP胶片颗粒效果强度）")]
	[FeedbackHelp("T此反馈允许您随时间控制URP膜颗粒强度。它要求场景中有一个体积为“Film Grain”活动的对象，以及一个MMFilmGrainShaker_URP组件。")]
