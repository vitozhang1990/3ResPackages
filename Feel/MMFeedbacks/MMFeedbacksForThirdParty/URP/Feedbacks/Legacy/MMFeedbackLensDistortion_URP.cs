...
{
	/// <summary>
	/// 此反馈允许您控制随时间变化的URP透镜畸变强度。它要求在场景中有一个具有激活镜头扭曲的体积的对象，以及一个mmLensDistorationShaker_URP组件。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("PostProcess（后处理）/Lens Distortion URP（URP畸变）")]
	[FeedbackHelp("此反馈允许您控制随时间变化的URP透镜畸变强度。它要求在场景中有一个具有激活镜头扭曲的体积的对象，以及一个mmLensDistorationShaker_URP组件。")]
