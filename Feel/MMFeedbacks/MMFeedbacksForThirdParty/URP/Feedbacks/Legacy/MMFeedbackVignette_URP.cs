...
{
	/// <summary>
	/// 此反馈允许您随时间控制URP渐晕强度。它要求场景中有一个具有激活渐晕的体积的对象，以及MMVignetteShaker_URP组件。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("PostProcess（后处理）/Vignette URP（URP渐晕强度）")]
	[FeedbackHelp("此反馈允许您随时间控制URP渐晕强度。它要求场景中有一个具有激活渐晕的体积的对象，以及MMVignetteShaker_URP组件。")]
