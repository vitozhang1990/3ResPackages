...
{
	/// <summary>
	/// 此反馈允许您随时间控制色差强度。它要求在场景中有一个具有激活HDRP色差的体积的对象，以及一个MMCOLORICALABERROTIONSHAKER_HDRP组件。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("PostProcess（后处理）/Chromatic Aberration HDRP（HDRP控制色差强度）")]
	[FeedbackHelp("此反馈允许您随时间控制色差强度。它要求在场景中有一个具有激活HDRP色差的体积的对象，以及一个MMCOLORICALABERROTIONSHAKER_HDRP组件。")]
