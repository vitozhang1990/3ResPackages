...
{
	/// <summary>
	/// 此反馈允许您随时间控制通道混合器的红色、绿色和蓝色。它要求场景中有一个具有激活通道混合器的体积的对象，以及一个MMChannelMixerShaker_HDRP组件。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("PostProcess（后处理）/Channel Mixer HDRP（HDRP制通道混合器的红色、绿色和蓝色）")]
	[FeedbackHelp("此反馈允许您随时间控制通道混合器的红色、绿色和蓝色。它要求场景中有一个具有激活通道混合器的体积的对象，以及一个MMChannelMixerShaker_HDRP组件。")]
