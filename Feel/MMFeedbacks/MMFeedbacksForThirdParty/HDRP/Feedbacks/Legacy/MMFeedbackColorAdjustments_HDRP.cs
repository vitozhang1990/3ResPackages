...
{
	/// <summary>
	/// 此反馈允许您随时间控制颜色调整的曝光后、色调偏移、饱和度和对比度。它要求在场景中有一个具有激活颜色调整的体积的对象，以及一个MMColorAdjustmentsShaker_HDRP组件。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("PostProcess（后处理）/Color Adjustments HDRP（HDRP控制颜色调整的曝光后、色调偏移、饱和度和对比度）")]
	[FeedbackHelp("此反馈允许您随时间控制颜色调整的曝光后、色调偏移、饱和度和对比度。它要求在场景中有一个具有激活颜色调整的体积的对象，以及一个MMColorAdjustmentsShaker_HDRP组件。")]
