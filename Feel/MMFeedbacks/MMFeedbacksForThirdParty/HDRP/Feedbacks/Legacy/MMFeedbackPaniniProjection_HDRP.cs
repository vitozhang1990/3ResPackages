...
{
	/// <summary>
	/// 此反馈允许您控制帕尼尼投影距离和裁剪，以适应时间的推移。它要求场景中有一个具有激活Bloom的体积的对象，以及一个MMPaniniProjectionShaker_HDRP组件。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("此反馈允许您控制帕尼尼投影距离和裁剪，以适应时间的推移。它要求场景中有一个具有激活Bloom的体积的对象，以及一个MMPaniniProjectionShaker_HDRP组件。")]
	[FeedbackPath("PostProcess（后处理）/Panini Projection HDRP（HDRP帕尼尼投影效果）")]
