...
{
	/// <summary>
	/// 此反馈允许您随时间控制HDRP透镜畸变强度。它要求场景中有一个具有激活镜头失真的体积的对象，以及一个mmLensDistorationShaker_HDRP组件。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("PostProcess（后处理）/Lens Distortion HDRP（HDRP控制镜头畸变强度）")]
	[FeedbackHelp("此反馈允许您随时间控制HDRP透镜畸变强度。它要求场景中有一个具有激活镜头失真的体积的对象，以及一个mmLensDistorationShaker_HDRP组件。")]
