...
{
	/// <summary>
	/// 此反馈允许您随时间控制开花强度和阈值。它要求场景中有一个具有Bloom活动的体积的对象和一个MMBloomShaker_HDRP组件。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("此反馈允许您随时间控制开花强度和阈值。它要求场景中有一个具有Bloom活动的体积的对象和一个MMBloomShaker_HDRP组件。")]
#if MM_HDRP
	[FeedbackPath("PostProcess（后处理）/Bloom HDRP（HDRP控制开花强度和阈值）")]
#endif
