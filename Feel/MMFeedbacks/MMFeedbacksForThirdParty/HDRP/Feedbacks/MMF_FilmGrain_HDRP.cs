...
{
	/// <summary>
	/// 此反馈允许您随时间控制HDRP膜颗粒强度。它要求场景中有一个体积为“Film Grain”活动的对象，以及一个MMFilmGrainShaker_HDRP组件。
	...
	[AddComponentMenu("")]
#if MM_HDRP
	[FeedbackPath("PostProcess（后处理）/Film Grain HDRP（HDRP胶片颗粒效果强度）")]
#endif
	[FeedbackHelp("此反馈允许您随时间控制HDRP膜颗粒强度。它要求场景中有一个体积为“Film Grain”活动的对象，以及一个MMFilmGrainShaker_HDRP组件。")]
