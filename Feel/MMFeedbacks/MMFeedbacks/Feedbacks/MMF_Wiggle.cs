...
{
	/// <summary>
	/// 通过此反馈，您可以在指定的持续时间内，在配备了MMWiggle组件的对象上触发位置、旋转和/或缩放摆动。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("通过此反馈，您可以在指定的持续时间内，在配备了MMWiggle组件的对象上触发位置、旋转和/或缩放摆动。")]
	[FeedbackPath("Transform/Wiggle（位置、旋转和、或缩放摆动）")]
