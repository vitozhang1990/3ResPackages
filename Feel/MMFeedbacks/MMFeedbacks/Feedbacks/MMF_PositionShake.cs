...
{
	/// <summary>
	/// 此反馈允许您发出PositionShake事件。这将由MMPositionShakers（在指定通道上）。顾名思义，位置抖动器用于沿方向抖动变换的位置，具有可选的噪波和其他精细控制选项。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("Transform/Position Shake（位置抖动）")]
	[FeedbackHelp("此反馈允许您发出PositionShake事件。这将由MMPositionShakers（在指定通道上）。顾名思义，位置抖动器用于沿方向抖动变换的位置，具有可选的噪波和其他精细控制选项。")]
