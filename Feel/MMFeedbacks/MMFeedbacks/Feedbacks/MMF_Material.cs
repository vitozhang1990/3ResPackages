...
{
	/// <summary>
	/// 此反馈将允许您在每次播放目标渲染器时更改其材质。
	/// This feedback will let you change the material of the target renderer everytime it's played.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("此反馈将允许您在每次播放目标渲染器时更改其材质。")]
	[FeedbackPath("Renderer（渲染器）/Material（材质球更换）")]
