...
{
	/// <summary>
	/// 此反馈允许您发出旋转抖动事件。这将由MMRotationShaker（在指定通道上）捕获。顾名思义，旋转抖动器用于沿方向抖动变换的旋转，具有可选的噪波和其他精细控制选项。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("Transform/Rotation Shake（旋转抖动）")]
	[FeedbackHelp("此反馈允许您发出旋转抖动事件。这将由MMRotationShaker（在指定通道上）捕获。顾名思义，旋转抖动器用于沿方向抖动变换的旋转，具有可选的噪波和其他精细控制选项。")]
