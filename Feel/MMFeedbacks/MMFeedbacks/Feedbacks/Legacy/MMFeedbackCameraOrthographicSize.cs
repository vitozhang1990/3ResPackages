...
{
	/// <summary>
	/// 通过此反馈，可以随时间控制相机的正交大小。你的相机上需要一个MMCameraOrthographicalSizeShaker。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("Camera（相机）/Orthographic Size（控制相机的正交大小）")]
	[FeedbackHelp("通过此反馈，可以随时间控制相机的正交大小。你的相机上需要一个MMCameraOrthographicalSizeShaker。")]
