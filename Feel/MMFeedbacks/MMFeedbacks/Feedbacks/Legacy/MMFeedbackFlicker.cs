...
{
	/// <summary>
	/// 此反馈将使绑定渲染器在播放时闪烁设定的持续时间（并在停止时恢复其初始颜色）
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("通过此反馈，您可以在特定的持续时间内，以指定的倍频程和指定的颜色闪烁指定渲染器（精灵、网格等）的颜色。例如，当角色被击中时很有用（但更多！）。")]
	[FeedbackPath("Renderer（渲染器）/Flicker（闪烁）")]
