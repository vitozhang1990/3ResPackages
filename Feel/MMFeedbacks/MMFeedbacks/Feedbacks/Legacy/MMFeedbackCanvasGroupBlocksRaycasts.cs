...
{
	/// <summary>
	/// 此反馈将允许您在播放时打开或关闭目标CanvasGroup的BlocksRaycast参数
	/// This feedback will let you turn the BlocksRaycast parameter of a target CanvasGroup on or off on play
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("此反馈将允许您在播放时打开或关闭目标CanvasGroup的BlocksRaycast参数")]
	[FeedbackPath("UI/CanvasGroup BlocksRaycasts(开关CanvasGroup的BlocksRaycast参数)")]
