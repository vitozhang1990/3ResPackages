...
{
	/// <summary>
	/// 通过此反馈，可以随时间控制摄影机的剪裁平面。你的相机上需要一个MMCameraClippingPlanesShaker。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("Camera（相机）/Clipping Planes（控制摄影机的剪裁平面）")]
	[FeedbackHelp("通过此反馈，可以随时间控制摄影机的剪裁平面。你的相机上需要一个MMCameraClippingPlanesShaker。")]
