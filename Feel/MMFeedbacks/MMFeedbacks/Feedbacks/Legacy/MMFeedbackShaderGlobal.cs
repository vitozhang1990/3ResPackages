...
{
	/// <summary>
	/// 此反馈允许您在着色器上设置全局属性，或启用/禁用关键字。
	/// This feedback allows you to set global properties on your shader, or enable/disable keywords.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("此反馈允许您在着色器上设置全局属性，或启用/禁用关键字。")]
	[FeedbackPath("Renderer（渲染器）/Shader Global（设置着色器全局属性）")]
