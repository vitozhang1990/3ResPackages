...
{
	/// <summary>
	/// 此反馈可用于控制高通滤波器的截止频率。您需要在过滤器上安装一个MMaudiofilter高通振荡器。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("Audio（音效）/Audio Filter High Pass（高通滤波器）")]
	[FeedbackHelp("此反馈可用于控制高通滤波器的截止频率。您需要在过滤器上安装一个MMaudiofilter高通振荡器。")]
