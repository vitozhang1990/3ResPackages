...
{
	/// <summary>
	/// 通过此反馈，您可以随时间改变目标精灵渲染器的颜色，并在X或Y方向上翻转它。您还可以使用它来命令一个或多个MMImageShakers。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("通过此反馈，您可以随时间改变目标精灵渲染器的颜色，并在X或Y方向上翻转它。您还可以使用它来命令一个或多个MMImageShakers。")]
	[FeedbackPath("UI/Image（改变图形颜色或者翻转方向）")]
