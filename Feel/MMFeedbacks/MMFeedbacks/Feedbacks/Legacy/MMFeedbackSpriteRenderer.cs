...
{
	/// <summary>
	/// 通过此反馈，您可以随时间改变目标精灵渲染器的颜色，并在X或Y方向上翻转它。您还可以使用它来命令一个或多个MMSPrienderMaker。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("通过此反馈，您可以随时间改变目标精灵渲染器的颜色，并在X或Y方向上翻转它。您还可以使用它来命令一个或多个MMSPrienderMaker。")]
	[FeedbackPath("Renderer（渲染器）/SpriteRenderer（改变目标精灵渲染器的颜色）")]
