...
{
	/// <summary>
	/// 此反馈允许您以各种方式控制视频播放器（播放、暂停、切换、停止、准备、前进、后退、SetPlaybackSpeed、SetDirectAudioVolume、SetDirectAudioMute、GoTofName、ToggleLoop）
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("此反馈允许您以各种方式控制视频播放器（播放、暂停、切换、停止、准备、前进、后退、SetPlaybackSpeed、SetDirectAudioVolume、SetDirectAudioMute、GoTofName、ToggleLoop）")]
	[FeedbackPath("UI/Video Player（视频播放器）")]
