...
{
	/// <summary>
	/// 通过此反馈，可以随时间控制相机的视野。您需要在相机上安装一个MMCameraFieldOfViewShaker。
	/// This feedback lets you control a camera's field of view over time. You'll need a MMCameraFieldOfViewShaker on your camera.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("Camera（相机）/Field of View（控制相机的视野）")]
	[FeedbackHelp("通过此反馈，可以随时间控制相机的视野。您需要在相机上安装一个MMCameraFieldOfViewShaker。")]
