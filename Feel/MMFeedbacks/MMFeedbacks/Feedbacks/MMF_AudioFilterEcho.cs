...
{
	/// <summary>
	/// 此反馈可用于控制回声滤波器的湿混级别。您需要在过滤器上安装一个MMAudioFilterEchoShaker。
	/// This feedback lets you control the wetmix level of an echo filter. You'll need a MMAudioFilterEchoShaker on your filter.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("Audio（音效）/Audio Filter Echo（回声滤波器）")]
	[FeedbackHelp("此反馈可用于控制回声滤波器的湿混级别。您需要在过滤器上安装一个MMAudioFilterEchoShaker。")]
