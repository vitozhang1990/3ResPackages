...
{
	/// <summary>
	/// 此反馈可用于控制混响滤波器的混响级别。您的过滤器上需要一个MMaudioFilter混响器。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("Audio（音效）/Audio Filter Reverb（混响滤波器）")]
	[FeedbackHelp("此反馈可用于控制混响滤波器的混响级别。您的过滤器上需要一个MMaudioFilter混响器。")]
