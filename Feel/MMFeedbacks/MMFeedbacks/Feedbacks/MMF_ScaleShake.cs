...
{
	/// <summary>
	/// 此反馈允许您发出ScaleShake事件。这将由MMSCALEShaker（在指定频道上）捕获。顾名思义，缩放抖动器用于沿一个方向抖动变换的缩放，具有可选的噪波和其他精细控制选项。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("Transform/Scale Shake（缩放抖动）")]
	[FeedbackHelp("此反馈允许您发出ScaleShake事件。这将由MMSCALEShaker（在指定频道上）捕获。顾名思义，缩放抖动器用于沿一个方向抖动变换的缩放，具有可选的噪波和其他精细控制选项。")]
