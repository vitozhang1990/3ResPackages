...
{
	/// <summary>
	/// 该反馈将在开始或播放时在指定位置实例化指定的ParticleSystem，可选地嵌套它们。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("该反馈将在开始或播放时在指定位置实例化指定的ParticleSystem，可选地嵌套它们。")]
	[FeedbackPath("Particles（粒子系统）/Particles Instantiation（粒子实例化）")]
