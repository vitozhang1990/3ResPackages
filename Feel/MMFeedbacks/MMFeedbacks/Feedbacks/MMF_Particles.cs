...
{
	/// <summary>
	/// 当播放时，此反馈将仅播放指定的ParticleSystem（来自场景）。
	/// This feedback will play the associated particles system on play, and stop it on stop
	/// This feedback will simply play the specified ParticleSystem (from your scene) when played.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("当播放时，此反馈将仅播放指定的ParticleSystem（来自场景）。")]
	[FeedbackPath("Particles（粒子系统）/Particles Play（播放粒子效果）")]
