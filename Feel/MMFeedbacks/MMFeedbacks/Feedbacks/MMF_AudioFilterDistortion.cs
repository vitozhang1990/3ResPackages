...
{
	/// <summary>
	/// 此反馈可用于控制失真滤波器的失真级别。您需要在过滤器上安装一个MMaudiofilterTransformationShaker。
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("Audio（音效）/Audio Filter Distortion（失真滤波器）")]
	[FeedbackHelp("此反馈可用于控制失真滤波器的失真级别。您需要在过滤器上安装一个MMaudiofilterTransformationShaker。")]
