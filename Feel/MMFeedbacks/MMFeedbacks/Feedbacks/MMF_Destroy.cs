...
{
	/// <summary>
	/// 此反馈允许您通过destroy、DestroyImmediate或SetActive:False销毁目标游戏对象
	/// This feedback allows you to destroy a target gameobject, either via Destroy, DestroyImmediate, or SetActive:False
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("此反馈允许您通过destroy、DestroyImmediate或SetActive:False销毁目标游戏对象")]
	[FeedbackPath("GameObject（游戏对象）/Destroy（对象激活销毁处理）")]
